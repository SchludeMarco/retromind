...
export const ChatBot: React.FC<{
  ...
  return (
    <div className="rm-fixed fixed bottom-36 left-4 md:left-10 z-50 w-80 max-w-[90vw] h-96 retro-card bg-retro-cream flex flex-col animate-fadeIn overflow-hidden">
